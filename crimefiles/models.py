...
class DummyAadharData(models.Model):
    ...
    aadharimage = models.ImageField(upload_to='aadharimages/', null=True, blank=True, default="")
...
class Facilitator_details(models.Model):
	...
	def __str__(self):
		return str(self.nameoffacilitator)
...
class Investigator_details(models.Model):
	...
	def __str__(self):
		return str(self.nameofinvestigator)
...
# facilitator
# Name, Address, phone, email, assignedtocase 
...
# 	complaintid=models.ForeignKey(Complaint,default=None,on_delete=models.CASCADE)
# 	signedby= models.CharField(max_length=20,null=True, blank=True, default="")
# 	content=models.CharField(max_length=200,null=True, blank=True,default="First Information Report not yet submitted")
# # complaintid, content(viewsofpolice), signature, 
...
#briefofoffence - userrole(witness,victim,hearsay),date and time of incidence, 
				 #placeofincidence, typeofincidence, description, userstatement)
#nameofsuspect, addressofsuspect, detailsofsuspect 
# sketch,sign,digitalsignature 
# fevidence, fstatment, viewsof facilitator, 
#investigator left
# doctorsreport left
